...
class FRModule(nn.Module):
    def __init__(self, nIn, d=1, kSize=3, dkSize=3):
        ...
        self.dconv3x1 = Conv(nIn // 2, nIn // 2, 3, 1,
                             padding=1, groups=nIn // 2, bn_acti=True)
...
class FRNet(nn.Module):
    def __init__(self, classes=19, block_1=2, block_2=5):
        ...
        self.FR_Block_1 = nn.Sequential()
        for i in range(0, block_1):
            self.FR_Block_1.add_module("FR_Module_1_" + str(i), FRModule(64, d=2))
        self.bn_prelu_2 = BNPReLU(128 + 3)

        dilation_block_2 = [2, 4, 4, 16, 16]
        self.downsample_2 = DownSamplingBlock(128 + 3, 128)
        self.FR_Block_2 = nn.Sequential()
        for i in range(0, block_2):
            self.FR_Block_2.add_module("FR_Module_2_" + str(i),
                                        FRModule(128, d=dilation_block_2[i]))
